...
import AnimatedBeamMultipleOutputDemo from "@/app/_utils/components/AnimatedBeam";
import { BentoCard, BentoGrid } from "@/components/magicui/bento-grid";
import Marquee from "@/components/magicui/marquee";
import AnimatedListDemo from "@/app/_utils/components/AnimatedList";
...
export function BentoDemo() {
  return (
    <BentoGrid className="max-w-full lg:max-w-[1150px] m-auto">
